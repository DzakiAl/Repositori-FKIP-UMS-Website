    ...
    <div class="content">
        ...
        <div class="file-manager-container">
            ...
            <div class="option-container">
                {{-- Upload File Form --}}
                <form action="{{ route('repository.upload_file', ['type' => $type, 'program' => $program]) }}"
                            ...
                            <td class="options">
                                <div class="options-container">
                                    ...
                                    <div class="context-menu">
                                        <a
                                            href="{{ route('repository.file_manager', ['type' => $type, 'program' => $program, 'folder' => $folder]) }}">Open</a>
                                        <a
                                            href="{{ route('repository.compress_folder', ['type' => $type, 'program' => $program, 'folder' => $folder]) }}">Compress
                                            to Zip</a>
                                        <a href="{{ route('repository.delete_folder', ['type' => $type, 'program' => $program, 'folder' => $folder]) }}"
